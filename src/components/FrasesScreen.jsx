...
function FrasesScreen({ volver }) {
  ...
  return (
    <div className="text-center flex flex-col items-center justify-center max-w-5xl mx-auto px-4 gap-y-1 overflow-y-hidden h-screen  -translate-y-10 md:-translate-y-0">
